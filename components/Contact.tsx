        ...
        <div className="space-y-8">
          <div className="bg-white/5 border border-white/10 p-8 relative overflow-hidden group">
            ...
            <p className="text-secondary mb-8 leading-relaxed font-light">
              Currently accepting new contract commissions and full-time
              engineering roles. Initiate communication via the secure form or
            ...
            <div className="space-y-4 font-mono text-sm">
              ...
              <div
                className="flex items-center gap-4 group/email cursor-pointer"
                onClick={handleCopy}
              >
                <Mail size={16} className="text-secondary" />
                <span className="text-white group-hover/email:text-blue-300 transition-colors">
                  {PORTFOLIO_DATA.email}
                </span>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-2">
              <label className="text-[10px] font-mono text-secondary uppercase tracking-wider">
                Agent Name
              </label>
              <input
                type="text"
